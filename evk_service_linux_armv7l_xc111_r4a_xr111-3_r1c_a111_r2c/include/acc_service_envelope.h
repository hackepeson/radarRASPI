...
typedef enum
{
	ACC_SERVICE_ENVELOPE_PROFILE_LONG_RANGE,
	ACC_SERVICE_ENVELOPE_PROFILE_SHORT_RANGE,
	ACC_SERVICE_ENVELOPE_PROFILE_MAX = ACC_SERVICE_ENVELOPE_PROFILE_SHORT_RANGE,
	ACC_SERVICE_ENVELOPE_PROFILE_DEFAULT = ACC_SERVICE_ENVELOPE_PROFILE_SHORT_RANGE
...
} acc_envelope_metadata_t;


/**
 * @brief Definition of an envelope callback function
 */
typedef void (acc_envelope_callback_t)(const acc_service_handle_t service_handle, const uint16_t *envelope_data, const acc_envelope_metadata_t *metadata, void *client_reference);
 ...
 */
extern void acc_service_envelope_envelope_callback_set(acc_service_configuration_t service_configuration, acc_envelope_callback_t *envelope_callback, void *client_reference);
 ...
 */
extern acc_service_status_t acc_service_envelope_get_next(acc_service_handle_t handle, uint16_t *envelope_data, uint16_t envelope_data_length);
